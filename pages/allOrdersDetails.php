...
$query = "SELECT bidding.Id, users.Name as supplierName, adminrequirements.Name, bidding.Pieces, bidding.TargetPrice, bidding.LeadTime, bidding.Status FROM bidding INNER JOIN adminrequirements ON adminrequirements.Id = bidding.AdminRequirementId INNER JOIN users ON users.Id = bidding.SupplierId WHERE bidding.Status = 'Accepted' || bidding.Status = 'Completed'";
            ...
            <div class="content">
                ...
                <table style="text-align: center;">
                    ...
                    <tbody style="text-align: center;">
                        <?php foreach ($fetch as $bidData) { ?>
                            <tr>
                                <td><?= $bidData["supplierName"] ?></td>
                                <td><?= $bidData["Name"] ?></td>
                                <td><?= $bidData["Pieces"] ?></td>
                                <td><?= $bidData["TargetPrice"] ?></td>
                                <td><?= $bidData["LeadTime"] ?></td>
