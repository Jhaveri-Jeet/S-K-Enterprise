...
$query = "SELECT requirementimages.ImageName, buyerrequirement.Id, buyerrequirement.BuyerId, buyerrequirement.Pieces, buyerrequirement.TargetPrice, buyerrequirement.Name, buyerrequirement.Description, buyerrequirement.LeadTime, buyerrequirement.TodaysDate FROM buyerrequirement INNER JOIN requirementimages ON requirementimages.BuyerRequirementId = buyerrequirement.Id LEFT JOIN adminrequirements ON buyerrequirement.Id = adminrequirements.BuyerRequirementId WHERE adminrequirements.BuyerRequirementId IS NULL";
...
<body><!-- page header -->
    ...
    <section>
        <div class="container-xxl">
            <div class="row justify-center">
                <?php foreach ($fetch as $buyerReqData) { ?>
                    <div class="col-4 mb-4 md:col-4 lg:col-4">
                        <article class="mt-7 rounded-2xl border-0 shadow">
                            <a href="#">
                                <img alt="" class="rounded-t-[18px]" style="object-fit: cover; width: 570px; height: 350px;" src="<?= urlOf("assets/uploads/") . $buyerReqData["ImageName"] ?>" loading="lazy" decoding="async">
                            </a>
                            <div class="px-[1.875rem] pb-[0.625rem] pt-[2.1rem]">
                                <h3 class="card-title h5 mb-2 font-semibold hover:underline">
                                    <a href="#"><?= $buyerReqData["Name"]; ?></a>
                                </h3>
                                <p class="mb-4 text-text"><?= $buyerReqData["Description"]; ?></p>
                            </div>
                            <div class="card-footer border-t-0 bg-transparent px-[1.875rem] pb-[2.1rem]">
                                <div class="row justify-center">
                                    <div class="col-6">
                                            ...
                                            <div class="flex items-center">
                                                ...
                                                <div class="user-info">
                                                    <p class="mb-0 font-medium">
                                                        <a href="author-single.html"><?= $buyerReqData["Pieces"]; ?></a>
                                                    </p>
                                        ...
                                        <div class="card-author mt-3">
                                            <div class="flex items-center">
                                                ...
                                                <div class="user-info">
                                                    <p class="mb-0 font-medium">
                                                        <a href="author-single.html"><?= $buyerReqData["TargetPrice"]; ?></a>
                                                    </p>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-6">
                                        <div class="card-author mt-3">
                                            <div class="flex items-center">
                                                ...
                                                <div class="user-info">
                                                    <p class="mb-0 font-medium">
                                                        <a href="author-single.html"><?= $buyerReqData["TodaysDate"]; ?></a>
                                                    </p>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="card-author mt-3">
                                            <div class="flex items-center">
                                                ...
                                                <div class="user-info">
                                                    <p class="mb-0 font-medium">
                                                        <a href="author-single.html"><?= $buyerReqData["LeadTime"]; ?></a>
                                                    </p>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="ml-autoflex order-1 hidden items-center justify-center md:ml-0 lg:order-2 lg:flex mt-4">
                                        <!-- <input type="button" class="btn btn-primary mt-6 w-full" onclick="sendBuyerRequirementId(<?= $buyerReqData['Id'] ?>)" value="Make live to Suppliers" /> -->
                                        <a class="btn btn-primary" href="<?= urlOf("pages/addAdminRequirement.php?id=") . $buyerReqData['Id']  ?>">Make live to Suppliers</a>
                                    </div>
                                </div>
                            </div>
                        </article>
    ...
    <script>
        function sendBuyerRequirementId(id) {
            let data = {
                buyerId: id,
            }

            $.post("addAdminRequirement.php", data, function(response) {
                console.log(response);
                window.location = "addAdminRequirement.php";
            })
        }
    </script>
    <?php
