...
$query = "SELECT bidding.Id, adminrequirements.Name, bidding.Pieces, bidding.TargetPrice, bidding.LeadTime, bidding.Status FROM bidding INNER JOIN adminrequirements ON adminrequirements.Id = bidding.AdminRequirementId WHERE bidding.SupplierId = ?";
$params = [$id];
                    ...
                    <tbody style="text-align: center;">
                        <?php foreach ($fetch as $bidData) { ?>
                            <tr>
                                ...
                                <?php if ($bidData["Status"] == "Accepted") { ?>
                                    <td><a class="btn btn-primary" href="<?= urlOf("api/completeBid.php?id=") . $bidData["Id"] ?>">Accept</a></td>
                                <?php } else { ?>
