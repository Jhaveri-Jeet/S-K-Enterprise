...
$id = $_SESSION["userId"];
$query = "SELECT buyerrequirement.Name, buyerrequirement.Pieces, buyerrequirement.Description, buyerrequirement.TargetPrice, buyerrequirement.LeadTime, buyerrequirement.TodaysDate, buyerrequirement.Status, requirementimages.ImageName FROM BuyerRequirement INNER JOIN requirementimages ON requirementimages.BuyerRequirementId = BuyerRequirement.Id WHERE BuyerId = '$id'";
...
<body><!-- page header -->
    <section class="section">
        <div class="container-xxl relative overflow-hidden">
            ...
            <div class="ml-autoflex items-center md:ml-0 lg:order-2 lg:flex" style="float: right; margin-right: -10px">
                <a class="btn btn-primary" href="<?= urlOf("./pages/addBuyerRequirement.php") ?>">Add Requirement</a>
            </div>
        </div>
    </section>
    <!-- end page header -->
    ...
    <section>
        <div class="container-xxl">
            <div class="row justify-center">
                <?php foreach ($fetch as $buyerRequirementData) { ?>
                    <div class="col-4 mb-4 md:col-4 lg:col-4">
                        <article class="mt-7 rounded-2xl border-0 shadow">
                            <a href="#">
                                <img alt="The Real Product From the Buyers improvements in Overflow basis." class="rounded-t-[18px]" style="object-fit: cover; width: 570px; height: 350px;" src="<?= urlOf("assets/uploads/") . $buyerRequirementData["ImageName"] ?>" loading="lazy" decoding="async">
                            </a>
                            <div class="px-[1.875rem] pb-[0.625rem] pt-[2.1rem]">
                                <h3 class="card-title h5 mb-2 font-semibold hover:underline">
                                    <a href="#"><?= $buyerRequirementData["Name"] ?></a>
                                </h3>
                                <p class="mb-4 text-text"><?= $buyerRequirementData["Description"] ?></p>
                            </div>
                                    ...
                                    <div class="col-6">
                                            ...
                                            <div class="flex items-center">
                                                ...
                                                <div class="user-info">
                                                    <p class="mb-0 font-medium">
                                                        <a href="author-single.html"><?= $buyerRequirementData["Pieces"] ?></a>
                                                    </p>
                                        ...
                                        <div class="card-author mt-3">
                                            <div class="flex items-center">
                                                ...
                                                <div class="user-info">
                                                    <p class="mb-0 font-medium">
                                                        <a href="author-single.html"><?= $buyerRequirementData["TargetPrice"] ?></a>
                                                    </p>
                                                    <!-- <span>April 4, 2022 - 02 Mins read</span> -->
                                                </div>
                                            </div>
                                    ...
                                    <div class="col-6">
                                        <div class="card-author mt-3">
                                            <div class="flex items-center">
                                                ...
                                                <div class="user-info">
                                                    <p class="mb-0 font-medium">
                                                        <a href="author-single.html"><?= $buyerRequirementData["TodaysDate"] ?></a>
                                                    </p>
                                                    <!-- <span>April 4, 2022 - 02 Mins read</span> -->
                                                </div>
                                            </div>
                                        ...
                                        <div class="card-author mt-3">
                                            <div class="flex items-center">
                                                ...
                                                <div class="user-info">
                                                    <p class="mb-0 font-medium">
                                                        <a href="author-single.html"><?= $buyerRequirementData["LeadTime"] ?></a>
                                                    </p>
                                                    <!-- <span>April 4, 2022 - 02 Mins read</span> -->
                                                </div>
                                            </div>
