<footer class="mt-24">
    <div class="container">
        <div class="row justify-center pb-12">
            ...
            <div class="mt-12 sm:col-6 md:col-6 lg:col-3 sm:mt-0">
                <div class="footer-widget">
                    <h4 class="h5 mb-6">Socials</h4>
                    <ul class="footer-links list-unstyled mb-6">
                        <li>
                            <a class="hover:text-primary hover:underline" href="mailto:info@andromeda.io">info@andromeda.io</a>
                        </li>
                    </ul>
                    ...
                    <ul class="social-icons mb-8">
                        ...
                        <li class="inline-block">
                            <a aria-label="pinterest" href="https://pinterest.com/" target="_blank" rel="noopener noreferrer nofollow">
                                <svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 512 512" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg">
            ...
            <div class="mt-12 sm:col-6 md:col-6 lg:col-2 lg:mt-0">
                <div class="footer-widget">
                    <h4 class="h5 mb-6">Quick Links</h4>
                    <ul class="footer-links list-unstyled">
                        <li class="mb-4">
                            <a class="hover:text-primary hover:underline" href="about.html">
                                About
                            </a>
                        </li>
                        <li class="mb-4">
                            <a class="hover:text-primary hover:underline" href="contact.html">
                                Contact
                            </a>
                        </li>
                        <li class="mb-4">
                            <a class="hover:text-primary hover:underline" href="terms-and-conditions.html">
                                Terms And Conditions
                            </a>
                        </li>
                        <li class="mb-0">
                            <a class="hover:text-primary hover:underline" href="changelog.html">
                                Changelog
                            </a>
                        </li>
                    </ul>
            ...
            <div class="mt-12 sm:col-6 md:col-6 lg:col-3 lg:mt-0">
                <div class="footer-widget">
                    <h4 class="h5 mb-6">Location &amp; Contact</h4>
                    <ul class="footer-links list-unstyled">
                        <li class="mb-4">
