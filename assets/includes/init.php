...
define("BASE_DIR", $_SERVER['DOCUMENT_ROOT'] . "/SKEnterprise");
define("BASE_URL", "/SKEnterprise");

date_default_timezone_set('Asia/Kolkata');

$connection = new PDO("mysql:host=localhost;port=3306;dbname=SKEnterpriseDb", "root", "");
